#undef LOWENTRYEXTENDEDSTANDARDLIBRARYEDITOR_API
#define IS_PROGRAM 0
#define UE_EDITOR 1
...
#define LOWENTRYEXTENDEDSTANDARDLIBRARYEDITOR_API DLLEXPORT
#define LOWENTRYEXTENDEDSTANDARDLIBRARY_API DLLIMPORT
