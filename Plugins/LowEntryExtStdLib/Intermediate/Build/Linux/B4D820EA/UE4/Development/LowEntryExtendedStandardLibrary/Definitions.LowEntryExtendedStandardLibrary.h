#undef LOWENTRYEXTENDEDSTANDARDLIBRARY_API
...
#define UBT_MODULE_MANIFEST_DEBUGGAME "UE4-Linux-DebugGame.modules"
...
#define UE_PROJECT_NAME SpaceTrain
#define UE_TARGET_NAME SpaceTrain
