...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriterPure_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriterPure_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_LowEntry_CreateByteDataWriterPure_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UK2Node_LowEntry_CreateByteDataWriterPure, 2297607412);
	template<> LOWENTRYEXTENDEDSTANDARDLIBRARYEDITOR_API UClass* StaticClass<UK2Node_LowEntry_CreateByteDataWriterPure>()
	{
		return UK2Node_LowEntry_CreateByteDataWriterPure::StaticClass();
	}
